...
Project: `/Users/tars/Desktop/waffler/`
...
Let users add words/names that Whisper gets wrong (e.g. "Waffler", "TARS", product names).
- Add a "Vocabulary" text area in the UI sidebar
- Save to `~/.waffler/vocab.json`
...
- On launch: minimise terminal, show tray icon with tooltip "Waffler running"
...
Simple one-page site to sell Waffler.
...
- Licence stored in `~/.waffler/license.json`
...
- [x] One-click launcher: run_windows.bat + Waffler.command
