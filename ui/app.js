...
let _lastCapturedKeys = isMacPlatform ? ["cmd", "option"] : ["win", "ctrl"];
let _currentHotkeyKeys = isMacPlatform ? ["cmd", "option"] : ["win", "ctrl"];
...
function resetHotkeyDefault() {
  _lastCapturedKeys = isMacPlatform ? ["cmd", "option"] : ["win", "ctrl"];
  _capturedKeys.clear();
  document.getElementById("hotkeyCaptureKeys").textContent = isMacPlatform ? "Command + Option" : "Win + Ctrl";
  document.getElementById("hotkeyError").style.display = "none";
}
