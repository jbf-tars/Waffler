...
let _lastCapturedKeys = isMacPlatform ? ["control", "option"] : ["win", "ctrl"];
let _currentHotkeyKeys = isMacPlatform ? ["control", "option"] : ["win", "ctrl"];
...
function resetHotkeyDefault() {
  _lastCapturedKeys = isMacPlatform ? ["control", "option"] : ["win", "ctrl"];
  _capturedKeys.clear();
  document.getElementById("hotkeyCaptureKeys").textContent = isMacPlatform ? "Control + Option" : "Win + Ctrl";
  document.getElementById("hotkeyError").style.display = "none";
}
